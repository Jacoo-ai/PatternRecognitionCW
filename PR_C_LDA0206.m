...
legend('Rubber', 'TPU');
grid on;
view(40, 30);  % Adjust view angle for better visualisation
%% 
% 1.c. LDA for combination of 2D
% Step 0: Standardise the data
disp = zscore(disp);
disp_sel = disp(:, 13:15);
...
for i = 1:3
    ...
    center_point = mean(disp_projected, 1);                 % Center point of the dicrimination line
    discrimination_slope = -lda_vector(1) / lda_vector(2);  % Slope of the discrimination line
